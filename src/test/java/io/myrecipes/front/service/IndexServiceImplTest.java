...
////        argThat(new IndexServiceImplTest.UrlMatcher(pageParam)), eq(HttpMethod.GET), eq(nullValue()), any(ParameterizedTypeReference.class)
////        given(this.restTemplate.exchange(argThat(new IndexServiceImplTest.UrlMatcher(pageParam)), eq(HttpMethod.GET), eq(nullValue()), any(ParameterizedTypeReference.class)))
